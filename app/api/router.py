import os  # Модуль для работы с операционной системой, например, для доступа к переменным окружения.

from fastapi import APIRouter, UploadFile, File, Depends, HTTPException
# APIRouter: для организации маршрутов API.
# UploadFile, File: для обработки загружаемых файлов.
# Depends: для инъекции зависимостей в эндпоинты.
...
# get_notifier: зависимость для получения уведомлений.
